    ...
    <div className="bg-gray-50 dark:bg-gray-900" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p className="pt-6 pb-6 text-base max-w-2xl text-center m-auto dark:text-gray-400">
          Have a project in mind or just want to say hi? Choose your preferred way to get in touch—I’m excited to collaborate and help bring your ideas to life.
        </p>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16 grid md:grid-cols-2 lg:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
        <div>
          ...
          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
            ...
            <a href="mailto:pamuduwijayabandara@outlook.com" className="underline hover:text-blue-500">
              pamuduwijayabandara@outlook.com
            </a>
          </div>
          <div className="flex items-center mt-2 space-x-2 text-dark-600 dark:text-gray-400">
            <svg
            ...
            <a href="tel:+94786491627" className="underline hover:text-blue-500">
              +94 786491627
            </a>
          </div>
        </div>
